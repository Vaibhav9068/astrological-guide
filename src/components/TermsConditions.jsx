...
export default function TermsConditions() {
  ...
  const sections = [
    {
      id: '1',
      title: t('terms_page.sec1_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec1_desc')}
        </p>
      ),
    },
    {
      id: '2',
      title: t('terms_page.sec2_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec2_desc')}
        </p>
      ),
    },
    {
      id: '3',
      title: t('terms_page.sec3_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec3_desc')}
        </p>
      ),
    },
    {
      id: '4',
      title: t('terms_page.sec4_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec4_desc')}
        </p>
      ),
    },
    {
      id: '5',
      title: t('terms_page.sec5_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec5_desc')}
        </p>
      ),
    },
    {
      id: '6',
      title: t('terms_page.sec6_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec6_desc')}
        </p>
      ),
    },
    {
      id: '7',
      title: t('terms_page.sec7_title'),
      content: (
        <p className="font-poppins text-sm text-[#4A3A2A]/90 leading-relaxed">
          {t('terms_page.sec7_desc')}
        </p>
      ),
    },
    {
      id: '8',
      title: t('terms_page.sec8_title'),
      content: (
        <div className="space-y-4 font-poppins text-sm text-[#4A3A2A]/90">
          ...
          <div className="space-y-1.5">
            ...
            <p><strong>{language === 'hi' ? 'व्हाट्सएप:' : 'WhatsApp:'}</strong> <a href="https://wa.me/918383941616" target="_blank" rel="noopener noreferrer" className="text-[#6D1A1A] hover:underline">+91 83839 41616</a></p>
      ...
      <div className="sticky top-[68px] lg:top-[80px] z-30 bg-[#FFF9EE]/90 backdrop-blur-md border-b border-[#D4AF37]/15 py-3 mb-12 shadow-xxs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center gap-2 font-poppins text-xs text-[#6A4A1C]">
            ...
            <span className="text-[#6D1A1A] font-bold">{t('terms_page.title')}</span>
          </div>
          <a
            href="#home"
          ...
          >
            <ArrowLeft className="w-3.5 h-3.5" /> {t('terms_page.back_to_home')}
          </a>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-poppins text-xs sm:text-sm text-[#6A4A1C] uppercase tracking-widest font-bold">
            {t('terms_page.last_updated')}: {lastUpdatedText}
          </p>
